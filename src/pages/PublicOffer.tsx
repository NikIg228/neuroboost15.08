        ...
        <AnimatedSection>
          <div className="bg-white rounded-2xl shadow-lg p-8">
            ...
            <p className="text-gray-700 mb-6">
              ТОО "ПромоРайз" (NeuroBoost) (далее – Исполнитель) о заключении договора на оказание услуг по внедрению 
            ...
            <div className="prose prose-lg max-w-none">
              ...
              <div className="bg-gray-50 p-4 rounded-lg">
                <p className="text-gray-700">
                  ...
                  БИН: 230240047941<br />
                  Адрес: Казахстан, г. Алматы, Бостандыкский район, ул. Темирязева, дом 69, кв. 32, 050057<br />
