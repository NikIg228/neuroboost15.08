...
const PartnersSection: React.FC = () => {
  const [partners, setPartners] = useState([
    { name: 'Halyk Bank', logo: '/images/partners/halyk-bank-logo-png-transparent.png' },
    { name: 'Beeline', logo: '/images/partners/beeline-logo_brandlogos.net_aeikq-512x462.png' },
    { name: 'Samruk-Kazyna', logo: '/images/partners/samruk-kazyna-logo-png-transparent.png' },
    { name: 'Air Astana', logo: '/images/partners/air-astana-logo-brandlogos.net_r1iucuymj.svg' },
    { name: 'Tele2', logo: '/images/partners/tele2-logo-brandlogos.net_zvtmj1gbg.svg' }
  ]);
            ...
            {doublePartners.map((partner, index) => (
              ...
              >
                <img
                  ...
                  className="h-6 sm:h-8 lg:h-12 w-auto object-contain opacity-60 group-hover:opacity-100 transition-all duration-300 grayscale group-hover:grayscale-0"
                  onError={(e) => {
            ...
            {doublePartners.map((partner, index) => (
              ...
              >
                <img
                  src={partner.logo}
                  alt={`${partner.name} logo`}
                  className="h-5 sm:h-6 lg:h-8 w-auto object-contain opacity-50 group-hover:opacity-80 transition-all duration-300 grayscale group-hover:grayscale-0"
                  onError={(e) => {
                    const target = e.target as HTMLImageElement;
                    target.style.display = 'none';
                    const textElement = document.createElement('div');
