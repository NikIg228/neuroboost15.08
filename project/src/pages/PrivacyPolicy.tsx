        ...
        <AnimatedSection>
          <div className="bg-white rounded-2xl shadow-lg p-8">
            ...
            <p className="text-gray-600 mb-8">
              ТОО "ПромоРайз" (NeuroBoost)(далее – Компания) в соответствии с требованиями Закона Республики Казахстан "О персональных данных и их защите".
            </p>
            ...
            <div className="prose prose-lg max-w-none">
              ...
              <div className="bg-gray-50 p-4 rounded-lg mb-6">
                <p className="text-gray-700">
                  <strong>ТОО "ПромоРайз" (NeuroBoost)</strong><br />
                  БИН: 230240047941<br />
                  Email: galuza_nikita@mail.ru<br />
                  Телефон: +7 (707) 506 29 00<br />
                  Адрес: Казахстан, г. Алматы, Бостандыкский район, ул. Темирязева, дом 69, кв. 32, 050057
                </p>
              </div>
            </div>
          </div>
